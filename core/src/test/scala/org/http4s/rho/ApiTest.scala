...
class ApiTest extends Specification {
  ...
  def runWith[F[_]: Sync, T <: HList, FU](exec: RouteExecutable[F, T])(f: FU)(implicit fpm: FuncParamsMatch[F, T, FU], hltf: HListToFunc[F, T, FU]): Request[F] => OptionT[F, Response[F]] = {
