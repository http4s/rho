...
class ParamDefaultValueSpec extends Specification {
  ...
  "GET /test3" should {
    ...
    "fail to map parameter with non-numeric value" in {
      body(requestGet("/test3?param1=value1")) must be equalTo "Invalid number format."
    }
    "map parameter without value" in {
  ...
  "GET /test5" should {
    ...
    "fail on parameter with non-numeric value" in {
      body(requestGet("/test5?param1=value1")) must be equalTo "Invalid number format."
    }
    "map parameter without value" in {
  ...
  "GET /test8" should {
    ...
    "fail to map parameter with one non-numeric value" in {
      body(requestGet("/test8?param1=test")) must be equalTo "Invalid number format."
    }
    ...
    "fail to map parameter with many non-numeric values" in {
      body(requestGet("/test8?param1=abc&param1=def")) must be equalTo "Invalid number format."
    }
    "map parameter without value" in {
  ...
  "GET /test10" should {
    ...
    "fail to map parameter with non-numeric value" in {
      body(requestGet("/test10?param1=value1")) must be equalTo "Invalid number format."
    }
  ...
  "GET /test11" should {
    ...
    "fail to map parameter with non-numeric value" in {
      body(requestGet("/test11?param1=value1")) must be equalTo "Invalid number format."
    }
    "map parameter with valid numeric value" in {
  ...
  "GET /test14" should {
    ...
    "fail to map parameter with one non-numeric value" in {
      body(requestGet("/test14?param1=test")) must be equalTo "Invalid number format."
    }
    "fail to map parameter with many non-numeric values" in {
      body(requestGet("/test14?param1=abc&param1=def")) must be equalTo "Invalid number format."
    }
